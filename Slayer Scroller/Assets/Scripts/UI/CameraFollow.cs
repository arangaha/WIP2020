...
public class CameraFollow : MonoBehaviour 
{
    ...
    void Update()
    {
        if (player != null)
        {
            ...
            Camera.main.orthographicSize = Mathf.MoveTowards(Camera.main.orthographicSize, targetOrtho, smoothSpeed * Time.deltaTime*5);
            transform.position = new Vector3(player.position.x, (Camera.main.orthographicSize-maxOrtho)*0.4f 
